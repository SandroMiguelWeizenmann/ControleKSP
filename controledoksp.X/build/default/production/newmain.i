...
# 75 "newmain.c"
char aceleracao,movX,movY;
unsigned char leitura[16]={"Testando Leds..."};
...
void __attribute__((picinterrupt(("")))) TrataInt (void){
    if(INTCON3bits.INT2IF){
        if (PORTBbits.RB2 != stt_ESTAGIO_1 ){
            UART_Write ('3');
            stt_ESTAGIO_1 = PORTBbits.RB2;
        }
...
void main(void)
 {
   ...
   if (PORTBbits.RB1 != stt_RCS ){
       PORTCbits.RC1 = PORTBbits.RB1;
       PORTCbits.RC0 = ~PORTBbits.RB1;
       UART_Write ('5');
       stt_RCS = PORTBbits.RB1;
    }

    if (PORTBbits.RB4 != stt_LUZ ){
       PORTAbits.RA4 = PORTBbits.RB4;
       PORTAbits.RA5 = ~PORTBbits.RB4;
       UART_Write ('U');
       stt_LUZ = PORTBbits.RB4;
    }

    if (PORTBbits.RB5 != stt_SAS){
       PORTAbits.RA3 = PORTBbits.RB5;
       PORTCbits.RC2 = ~PORTBbits.RB5;
       UART_Write ('4');
       stt_SAS = PORTBbits.RB5;
    }


    if(PORTBbits.RB6 != stt_PRN1 || PORTBbits.RB7 != stt_PRN2){
      if ((PORTBbits.RB6 == 1 && PORTBbits.RB7 == 1)){
       ...
       UART_Write ('p');
       UART_Write ('n');
       stt_PRN1 = PORTBbits.RB6;
       stt_PRN2 = PORTBbits.RB7;
    }
     else if((PORTBbits.RB6 == 0 && PORTBbits.RB7 ==1)){
       PORTEbits.RE1 = 1;
   ...
   if( PORTBbits.RB3 != stt_EMER){
       UART_Write('E');
    stt_EMER = PORTBbits.RB3;
    }
